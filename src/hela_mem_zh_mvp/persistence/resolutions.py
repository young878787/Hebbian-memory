...
def _would_cycle(
    session: Session, namespace_id: object, source_id: object, target_id: object
) -> bool:
...
def apply_resolution(
    ...
    if incoming.namespace_id != namespace_id or any(
        item.namespace_id != namespace_id for item in targets
    ):
